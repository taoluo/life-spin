...
Like [[Library/LifeOS/Pages/Today]], this is a shell around a view function —
`lifeos.views.projects()` — that returns Markdown and knows nothing about where it is displayed.
